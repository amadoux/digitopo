package io.digitopo.application.repository;

import io.digitopo.application.DigitopoApp;
import io.digitopo.application.config.Constants;
import io.digitopo.application.config.audit.AuditEventConverter;
import io.digitopo.application.domain.PersistentAuditEvent;
...
import static io.digitopo.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
